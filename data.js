...
const MENU_DATA = {
  ...
  drinks: {
    ...
    categories: {
      ...
      "Soda's on Tap": { items: [
        { id: "st1", name: "Pepsi", desc: "", mods: "tap_soda" },
        { id: "st2", name: "Pepsi Max", desc: "", mods: "tap_soda" },
        { id: "st3", name: "Tango", desc: "", mods: "tap_soda" },
        { id: "st4", name: "Lemonade", desc: "", mods: "tap_soda" },
      ]},
      "London Essence": { items: [
        { id: "le1", name: "Indian Tonic", desc: "", mods: "softdrink" },
        { id: "le2", name: "Craft Lemonade", desc: "", mods: "softdrink" },
        { id: "le3", name: "Ginger Ale", desc: "", mods: "softdrink" },
        { id: "le4", name: "White Peach", desc: "", mods: "softdrink" },
        { id: "le5", name: "Raspberry & Rose", desc: "", mods: "softdrink" },
        { id: "le6", name: "Orange & Elderflower", desc: "", mods: "softdrink" },
      ]},
      "Cordials": { items: [
