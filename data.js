// ============================================================
// MENU DATA — bundled fallback & initial sync source
// Hours format: { schedules: [{ days:[0-6], start: mins, end: mins }] }
// null = always available
// Categories: items[] = flat list, subcategories{} = nested 3rd level
// ============================================================

const MENU_DATA = {
  breakfast: {
    label: "Breakfast",
    hours: { schedules: [{ days: [6, 0], start: 540, end: 690 }] },
    categories: {
      "Breakfast Bites": { items: [
        ...
        { id: "bb6", name: "Eggs on Toast", desc: "Poached, scrambled or fried eggs on fresh bread. (V)" },
  ...
  lunch: {
    label: "Lunch",
    hours: { schedules: [{ days: [1, 2, 3, 4, 5], start: 720, end: 960 }] },
    categories: {
      "Starters": { items: [
        ...
        { id: "ls3", name: "Salt Baked Rainbow Beetroot", desc: "With a choice of white or granary bread roll. (V)(GF)" },
        { id: "ls4", name: "Pan Fried Garlic Mushroom", desc: "With siracha mayonnaise. (V)(GF)" },
        { id: "ls5", name: "Soup of the Day", desc: "With white or granary bread roll. (GF Available)" },
      ]},
      "Classic Mains": { items: [
  ...
  evening: {
    label: "Evening",
    hours: { schedules: [
      { days: [1, 2, 3, 4], start: 960, end: 1185 },
      { days: [5, 6], start: 960, end: 1215 }
    ]},
    categories: {
      "Starters": { items: [
  ...
  dessert: {
    ...
    categories: {
      "Desserts": { items: [
        ...
        { id: "ds4", name: "Treacle Tart", desc: "With custard or ice cream. (V)" },
      ...
      "Ice Cream & Sorbet": { items: [
        { id: "ic1", name: "Ice Cream", desc: "£2.00 per scoop — Vanilla, Strawberry, Mint Choc Chip, Chocolate, Raspberry Cheesecake, Honeycomb, Cookie Dough, Cherry Chocolate, Rum & Raisin, Salted Caramel", mods: "scoops", flavours: ["Vanilla", "Strawberry", "Mint Choc Chip", "Chocolate", "Raspberry Cheesecake", "Honeycomb", "Cookie Dough", "Cherry Chocolate", "Rum & Raisin", "Salted Caramel"] },
        { id: "sb1", name: "Sorbet", desc: "£2.00 per scoop — Raspberry, Mango (V)(VE)(GF)", mods: "scoops", flavours: ["Raspberry", "Mango"] },
      ]},
      "Dessert Extras": { items: [
  ...
  children: {
    ...
    categories: {
      "Children's Food": { items: [
        { id: "ch1", name: "Chicken Nuggets", desc: "With chips and beans or peas. (GF Available)" },
        { id: "ch2", name: "Chicken Burger", desc: "With chips and beans or peas. (GF Available)", isBurger: true },
        { id: "ch3", name: "Linguini with Beef Bolognaise", desc: "" },
        { id: "ch4", name: "Fresh Haddock Goujons", desc: "With chips and beans or peas. (GF Available)", isFishChips: true },
        { id: "ch5", name: "Quorn Sausage", desc: "With chips and beans or peas. (GF)(VE)" },
      ]},
      "Children's Drinks": { items: [
        { id: "cd1", name: "Fruit Shoot", desc: "Orange, Apple and Blackcurrant, Summer Fruits", mods: "flavour", flavours: ["Orange", "Apple and Blackcurrant", "Summer Fruits"] },
      ...
      "Children's Desserts": { items: [
        { id: "cds1", name: "Ice Cream", desc: "Vanilla, Strawberry or Chocolate. £2.00/scoop", mods: "scoops", flavours: ["Vanilla", "Strawberry", "Chocolate"] },
        { id: "cds2", name: "Sorbet", desc: "Raspberry or Mango. (V)(VG) £2.00/scoop", mods: "scoops", flavours: ["Raspberry", "Mango"] },
      ]}
    }
  },
  sunday: {
    label: "Sunday",
    hours: { schedules: [{ days: [0], start: 720, end: 1095 }] },
    categories: {
      "Starters": { items: [
  ...
  drinks: {
    ...
    categories: {
      ...
      "Bottles": { items: [
        { id: "bt1", name: "Hawkstone Cider", desc: "" },
        { id: "bt2", name: "Hawkstone Hedgerow", desc: "" },
        { id: "bt3", name: "Hawkstone Premier", desc: "" },
        { id: "bt4", name: "Hawkstone Session", desc: "" },
        { id: "bt5", name: "Hawkstone Pils", desc: "" },
        { id: "bt6", name: "Desperados", desc: "" },
        { id: "bt7", name: "Rekorderlig", desc: "Strawberry & Lime or Wild Berries" },
        { id: "bt8", name: "Smirnoff Ice", desc: "" },
        { id: "bt9", name: "Peroni", desc: "(GF Available)" },
        { id: "bt10", name: "Atlantic Pale Ale", desc: "" },
        { id: "bt11", name: "WKD Blue", desc: "" },
        { id: "bt12", name: "Doom Bar", desc: "" },
        { id: "bt13", name: "Timothy Taylors", desc: "" },
        { id: "bt14", name: "Budweiser", desc: "" },
      ]},
      "0% Bottles": { items: [
        { id: "na1", name: "Doom Bar 0%", desc: "" },
        { id: "na2", name: "Madri 0%", desc: "" },
        { id: "na3", name: "Guinness 0%", desc: "" },
        { id: "na4", name: "Peroni 0%", desc: "" },
        { id: "na5", name: "Corona 0%", desc: "" },
        { id: "na6", name: "Kopparberg 0%", desc: "Pear or Mixed Berries" },
      ]},
      "Spirits": { subcategories: {
        ...
        "Gin": [
          ...
          { id: "sg8", name: "Whitley & Neill", desc: "Raspberry, Ginger & Rhubarb, Black Cherry, Parma Violet", mods: "spirit" },
          { id: "sg9", name: "Kopparberg Gin", desc: "Passionfruit, Strawberry & Lime", mods: "spirit" },
          { id: "sg10", name: "Gordon Gin", desc: "White Peach, Sloe, Passionfruit, Lemon, Pink", mods: "spirit" },
        ],
        "Rum": [
          { id: "sr1", name: "Bambu", desc: "", mods: "spirit" },
          { id: "sr2", name: "Hawksbill Mango", desc: "", mods: "spirit" },
          { id: "sr3", name: "Kraken Spiced", desc: "", mods: "spirit" },
          { id: "sr4", name: "Twin Fin Golden Spiced", desc: "", mods: "spirit" },
          { id: "sr5", name: "Captain Morgan Tikki", desc: "", mods: "spirit" },
          { id: "sr6", name: "Captain Morgan Spiced / Dark", desc: "", mods: "spirit" },
          { id: "sr7", name: "Bacardi", desc: "", mods: "spirit" },
          { id: "sr8", name: "Malibu", desc: "", mods: "spirit" },
          { id: "sr9", name: "Dead Mans Finger", desc: "", mods: "spirit" },
        ],
        "Whisky / Bourbon": [
          { id: "sw1", name: "Isle of Jura 10 Years", desc: "", mods: "spirit" },
          { id: "sw2", name: "Naked Grouse", desc: "", mods: "spirit" },
          { id: "sw3", name: "Monkey Shoulder", desc: "", mods: "spirit" },
          { id: "sw4", name: "Jameson", desc: "", mods: "spirit" },
          { id: "sw5", name: "Bells", desc: "", mods: "spirit" },
          { id: "sw6", name: "Jack Daniels", desc: "Original / Honey", mods: "spirit" },
          { id: "sw7", name: "Southern Comfort", desc: "", mods: "spirit" },
        ],
        "Other Spirits": [
          { id: "so1", name: "Archers", desc: "", mods: "spirit" },
          { id: "so2", name: "Tia Maria", desc: "", mods: "spirit" },
          { id: "so3", name: "Baileys 50ml", desc: "", mods: "spirit" },
          { id: "so4", name: "Disaronno", desc: "", mods: "spirit" },
          { id: "so5", name: "Martini Dry 50ml", desc: "", mods: "spirit" },
          { id: "so6", name: "Limoncello", desc: "", mods: "spirit" },
          { id: "so7", name: "Pimm's", desc: "", mods: "spirit" },
          { id: "so8", name: "Jägermeister", desc: "", mods: "spirit" },
        ],
        "Brandy": [
          { id: "sbr1", name: "Martel Cognac", desc: "", mods: "spirit" },
          { id: "sbr2", name: "Three Barrells", desc: "", mods: "spirit" },
          { id: "sbr3", name: "Cherry Brandy", desc: "", mods: "spirit" },
        ],
        "Shots / Bombs": [
          { id: "sh1", name: "Tequila", desc: "", mods: "spirit" },
          { id: "sh2", name: "Tequila Rose", desc: "", mods: "spirit" },
          { id: "sh3", name: "Sourz Range", desc: "", mods: "spirit" },
          { id: "sh4", name: "Sambuca Range", desc: "", mods: "spirit" },
        ]
      }},
      "Soft Drinks": { items: [
        { id: "sd1", name: "J2O Range", desc: "Apple & Raspberry, Orange & Passionfruit, Apple & Mango, Dragon Berry", mods: "flavour_ice", flavours: ["Apple & Raspberry", "Orange & Passionfruit", "Apple & Mango", "Dragon Berry"] },
        ...
        { id: "sd10", name: "Harrogate Still", desc: "", mods: "softdrink" },
        { id: "sd11", name: "Harrogate Sparkling", desc: "", mods: "softdrink" },
        { id: "sd12", name: "Fresh Juice", desc: "Orange, Cranberry, Pineapple and Apple", mods: "flavour_ice", flavours: ["Orange", "Cranberry", "Pineapple", "Apple"] },
        { id: "sd13", name: "Fruit Shoot", desc: "Summer Fruits, Orange and Apple & Blackcurrant", mods: "flavour", flavours: ["Summer Fruits", "Orange", "Apple & Blackcurrant"] },
      ]},
      "Soda's on Tap": { items: [
        { id: "st1", name: "Pepsi", desc: "Pint / Regular / Dash" },
        { id: "st2", name: "Pepsi Max", desc: "Pint / Regular / Dash" },
        { id: "st3", name: "Tango", desc: "Pint / Regular / Dash" },
        { id: "st4", name: "Lemonade", desc: "Pint / Regular / Dash" },
      ]},
      "London Essence": { items: [
        { id: "le1", name: "Indian Tonic", desc: "" },
        { id: "le2", name: "Craft Lemonade", desc: "" },
        { id: "le3", name: "Ginger Ale", desc: "" },
        { id: "le4", name: "White Peach", desc: "" },
        { id: "le5", name: "Raspberry & Rose", desc: "" },
        { id: "le6", name: "Orange & Elderflower", desc: "" },
      ]},
      "Cordials": { items: [
        { id: "co1", name: "Britvic Orange", desc: "" },
        { id: "co2", name: "Britvic Bitter Lemon", desc: "" },
        { id: "co3", name: "Cordial & Water", desc: "Blackcurrant, Orange or Lime", mods: "cordial", flavours: ["Blackcurrant", "Orange", "Lime"] },
        { id: "co4", name: "Pint Cordial & Soda", desc: "Blackcurrant, Orange or Lime", mods: "cordial", flavours: ["Blackcurrant", "Orange", "Lime"] },
        { id: "co5", name: "Half Cordial & Soda", desc: "Blackcurrant, Orange or Lime", mods: "cordial", flavours: ["Blackcurrant", "Orange", "Lime"] },
      ]},
      "Cocktails": { items: [
        { id: "ck1", name: "Pornstar Martini", desc: "" },
        { id: "ck2", name: "Raspberry Cola Cube", desc: "" },
        { id: "ck3", name: "Espresso Martini", desc: "" },
        { id: "ck4", name: "Aperol Spritz", desc: "" },
        { id: "ck5", name: "Glitter Bomb", desc: "" },
        { id: "ck6", name: "Pina Colada", desc: "" },
        { id: "ck7", name: "Sex on the Beach", desc: "" },
        { id: "ck8", name: "Mojito", desc: "Sweet or Dry" },
        { id: "ck9", name: "Mojito Passionfruit", desc: "Sweet or Dry" },
      ]},
      "Mocktails": { items: [
        { id: "mk1", name: "Oceana Colada", desc: "" },
        { id: "mk2", name: "Naked Porn Star", desc: "" },
        { id: "mk3", name: "Nojito", desc: "Sweet or Dry" },
        { id: "mk4", name: "Nojito Passionfruit", desc: "Sweet or Dry" },
      ]},
      "Hot Drinks": { subcategories: {
        "Coffee & More": [
          { id: "hd1", name: "Espresso", desc: "" },
          { id: "hd2", name: "Black Americano", desc: "" },
          { id: "hd3", name: "White Coffee", desc: "" },
          { id: "hd4", name: "Flat White", desc: "" },
          { id: "hd5", name: "Cappuccino", desc: "" },
          { id: "hd6", name: "Latte", desc: "" },
          { id: "hd7", name: "Mocha", desc: "" },
          { id: "hd8", name: "Choccalatte", desc: "" },
          { id: "hd9", name: "Pot Of Tea", desc: "" },
          { id: "hd10", name: "Flavoured Tea", desc: "Earl Grey, Green Tea, Camomile, Peppermint" },
          { id: "hd11", name: "Hot Chocolate", desc: "" },
        ],
        "Hot Drink Extras": [
          { id: "he1", name: "Jug of Cream / Extra Milk", desc: "" },
          { id: "he2", name: "Caramel Syrup", desc: "" },
          { id: "he3", name: "Hazelnut Syrup", desc: "" },
